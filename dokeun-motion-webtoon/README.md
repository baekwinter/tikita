...
- 서버 `1539519514956398692` · 이벤트(공식 게시) 채널 `1548252787002048572` · 게임 참여 채널 `#도근고-추리-토론(1552877179187232798)`
...
- 초대 후, 이벤트 채널 `1548252787002048572` 과 게임 채널 `#도근고-추리-토론(1552877179187232798)` 에서 봇 역할에 위 권한이 실제로 허용되어 있는지 채널 권한을 확인하세요.
