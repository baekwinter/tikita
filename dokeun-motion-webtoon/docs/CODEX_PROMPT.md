...
- 봇 이름: 도근고등학교 달빛 방송부
- 디스코드 서버 ID 1539519514956398692, 이벤트 채널 ID 1548252787002048572, 게임 채널 ID 1552877179187232798
...
2. 토큰 검증 (읽기 전용)
   ...
   - `GET /channels/1548252787002048572`, `GET /channels/1552877179187232798` 가 200 인지 확인(403 이면 채널 권한 문제로 보고).
